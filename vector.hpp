...
namespace cov {
	...
	template<typename data_t, typename size_t, size_t chunk_size, template<typename> class allocator_t> allocator_t<data_t> vector<data_t, size_t, chunk_size, allocator_t>::m_allocator;
}